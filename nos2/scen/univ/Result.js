...
class Result {
    ...
    plaque() {
        ...
        let bgRect = paper.rect(0, 0, paper.attr("width"), paper.attr("height")).attr({
            fill: "yellow", stroke: "#567" , "stroke-width": "3"
        });
        let theText = paper.text(3, 18, this.toString()).attr({"font-size" : 12});
