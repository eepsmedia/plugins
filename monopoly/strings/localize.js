...
const localize = {
    ...
    fileNameMap : {
        en : "strings/monopoly_English.json",
        es : "strings/monopoly_Spanish.json",
        de : "strings/monopoly_German.json",
        fr : "strings/monopoly_French.json",
        it : "strings/monopoly_Italian.json",
    },
    ...
    getString : function(iID, ...theArgs) {
        const theRawString = eval(`DG.plugins.monopoly.${iID}`);
        let out = "";
        if (theRawString) {
            out = replaceSubstrings(theRawString, ...theArgs);
        } else {
            const theDefaultString = eval(`this.defaultStrings.monopoly.${iID}`);
            if (theDefaultString) {
    ...
    setStaticStrings: async function () {
        ...
        const theStaticStrings = DG.plugins.monopoly.staticStrings;
