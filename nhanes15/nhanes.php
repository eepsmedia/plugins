...
switch ($command) {
    ...
    case 'getCases':
        ...
        if (strlen($joinString) > 1) {
            $joinString = "WHERE $joinString";
        } else {
            $joinString = "";
        }

        $query = "SELECT $theVariables FROM $tableString $joinString ORDER BY RAND( ) LIMIT :n";
    ...
    case 'getAllAttributeInfo':
        ...
        //  error_log("getAllAttributeInfo: ". print_r($out, true));
